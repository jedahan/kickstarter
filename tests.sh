...
assert './ksr.py list Awesome_Sauce' '-- John backed for $50
-- Jane backed for $50
...
assert './ksr.py list Floating_target' '-- Kwabena backed for $50.01
...
assert './ksr.py list Add_then_remove' '-- Mary backed for $99.99
Add_then_remove needs $400.01 more dollars to be successful'

assert './ksr.py backer Mary' '-- Backed Awesome_Sauce for $400
